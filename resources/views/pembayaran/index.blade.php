              ...
              <table class="table align-items-center mb-0">
                <thead class="bg-gray-100">
                  <tr>
                    ...
                    <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Payment Name</th>
                    <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Payment Status</th>
                    ...
                    <tbody>
                        @if ($pembayaran->count() > 0)
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <span class="text-secondary text-xs font-weight-bold">{{$pb->nama_pembayaran}}</span>
                                </td>
                                <td class="align-middle text-center text-sm">
                                    <span class="text-secondary text-xs font-weight-bold">{{$pb->status_pembayaran}}</span>
                                </td>
                                <td class="align-middle text-center text-sm">
